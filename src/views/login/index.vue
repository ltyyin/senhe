			...
			<main class="main-content-wrap">
				<div class="main-content">
					<div class="welcome-title">
						欢迎登录森和<i class="shequ shequ-shequ"></i>
					</div>
					<!-- 输入手机号获取验证码输入模块 -->
					<GetVerifyCode v-if="displayField" @smsCode="smsCode = $event" />
					<AccountLoign v-else />
				</div>
			</main>
...
<script>
import GetVerifyCode from '@/views/login/components/GetVerifyCode.vue'
import AccountLoign from '@/views/login/components/AccountLogin.vue'
import VerifySms from '@/views/login/components/VerifySms.vue'
...
export default {
	...
	computed: {
		...mapState('loginModel', ['showLogin', 'displayField']),
	},
